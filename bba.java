...
public class bba extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String pom = jTextField6.getText();
        String be = jTextField7.getText();
        String bms = jTextField8.getText();
        String mm = jTextField9.getText();
        ...
        try{
            ...
            if(rs.next() && "BBA".equals(rs.getString(2))){
                st.executeUpdate("insert into bba_result(Roll_No, Principles_of_Management, Business_Economics, Business_Math_And_Statistics, Marketing_Management) values('"+rollno+"','"+pom+"','"+be+"','"+bms+"','"+mm+"')");
                JOptionPane.showMessageDialog(null,"Result is save successfully !");
                setVisible(false);
                new insertresult().setVisible(true);
            }
            else{
