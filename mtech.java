...
public class mtech extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Design and Analysis of Algorithms :");

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 2, 14)); // NOI18N
        jLabel3.setText("Computational Number Theory :");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String cnt = jTextField7.getText();
        String pr = jTextField8.getText();
        String cd = jTextField9.getText();
        ...
        try{
            ...
            if(rs.next() && "M.Tech".equals(rs.getString(2))){
                st.executeUpdate("insert into mtech_result(Roll_No, DAA, CNT, Pattern_Recognition, Compiler_Design) values('"+rollno+"','"+daa+"','"+cnt+"','"+pr+"','"+cd+"')");
